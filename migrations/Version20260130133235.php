 ...
 */
final class Version20260130133235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE batiment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, adresse VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCEC9EFD6F6891B ON personne (batiment_id)');
